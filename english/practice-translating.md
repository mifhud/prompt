...
## Act as an English Language Professional
...
## Practice for translating from Indonesian to English

### For a single sentence

```
Provide me with an Indonesian sentence appropriate for a B2 level English test. I will translate it into English. Evaluate my response and offer the accurate translation along with a score and an explanation.
```

### For a paragraph

```
Provide me with an Indonesian paragraph appropriate for a B2 level English test. I will translate it into English. Evaluate my response and offer the accurate translation along with a score and an explanation.
```

### For a multiple sentences

```
Offer me several interconnected sentences within the context of their discussion to form a paragraph in Indonesian suitable for an English B1 level test. I'll translate them into English. Review my response and furnish the accurate translation along with a score and an explanation.
```

### Provide the answer

```
Give me the answer without requiring me to input the answer.
```
